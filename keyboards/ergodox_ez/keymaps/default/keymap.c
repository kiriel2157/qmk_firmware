 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |CTLR  |  GUI |ALT   | ALFT | CLSFT|                                       |   [  |   ]  |  ALT |GU/SB |   _   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | Home | END  |       | PgUp |PgDn    |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
             ...
             LALT(KC_SPC),	KC_N,			KC_M,			KC_COMM,	KC_DOT,			LT(MDIA, KC_SLSH),JA_AT,
             								JA_LBRC,		JA_RBRC,	KC_RALT,		LT(SYMB, KC_NO),	JA_ENUN,
             KC_PGUP,		KC_PGDN,
             KC_UP,
             KC_DOWN,		KC_ENT,			KC_DEL
    ),
...
[SYMB] = KEYMAP(
       ...
       KC_F12 , KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F12,
